...
// ACCESSING METHODS ------------------------------------------------
  ...
  /**
   * Provides access to the client socket used for communication with the server.
   * This method allows subclasses to safely retrieve the socket for custom operations,
   * such as initializing streams or monitoring the connection state.
   *
   * @return the client socket connected to the server.
   */
  protected Socket getSocket() {
      return clientSocket;
  }// had to add this method
